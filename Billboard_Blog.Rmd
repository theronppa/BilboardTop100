...
2. Repeat that for 5700 songs.
3. Do simple community detection on the data.
4. Map it in gephi and observe results.
5. Map accutal Genres on the community graph and work out ratios in R.
6. Determine if our question is valid.


*Preparing data for question*
...
Originally there was 100 different identified communities but for visualization we filtered for the 9  biggest communities. The remaining 91 communities, however, were not exlcuded from our data analysis process.
...
*So is there a correlation between collaborations and genres?*
Looking back at our question,  we need to determine if this graph does in fact show genre. 
By just looking at graph, the it does seem that similar artists group together (like that of Drake, Kanye West and DJ Khaled ) making us positive about the results we'll get back from the actual stats. To truly see wether these communities are showcasting genres we needed to extract the genre-ratios found in each community. This will show us wether one genre is promonent within a given community.

To do this we took the `collaboration dataset` and compared the edge & node tables determined:

1. Which genres where in a give community &
2. What were the genre-ratio proportinal to the community's size. 

*Our findings:*
From the 100 identified communities 70% of them had one primary genre and 94% of the communities had a genre that made up more than 50% of the community's size. This is great news as it shows how the community detection had a high level of accuracy in determining the genre communities.
...
From this we can concluded that the factors that were leading groups to collaborate in communities could definitly be linked to the genres of those artists. Thus this form of community detection can help identify genre collaborations. 
...
Rihanna seems to be playing a strong bridging role in her community exposing it to more genres and possibily making it easier for artists inside her community to do future collaborations through her existing ties.
