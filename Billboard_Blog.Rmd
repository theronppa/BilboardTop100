...
Not applying any statistical inferences, at this point, it does seem that similar artists like Drake, Kanye West and DJ Khaled group together within the network pointing to some truth to our assumptions.  

To further investigate the viability of our assumption we added genre to the edges to see if the communities truly reflect a common link of genre. 

We applied some data analysis methods in R to sample genres and give back stats on the ratios of genres found inside a community. 
...
The result from our stats in R were as follwos: 
70% < 100% genre > 
94% < >50% > 
