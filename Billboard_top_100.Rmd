...
Ever wonderded what weird and wonderful facts can be deduced from looking at our favourite tracks over the past 58 years? 

The best place to look for this is the Billboard Top 100. 

This Dataset boasts the Top 100 hits from 1960 to 2015. This set includes four packages within the dataset that we were able to conduct network analysis and inferences upon. 

In order to gain the most recent, and most reliable results, it was important to ensure that the years 2017 and 2018 were included in the dataset. This was done by scraping the web for songs and the lyrics of the songs for 2017 and 2018 Billboard Top 100. 

Since this study is aimed towards a music dataset, it was important to clean and organize the data in a way that is approppriate for making analysis' on the dataset. 

One can download the "Billboard Hot 100" package, and within it find four useful datasets. 
...
Luckily, the "spotify_track_data" dataset has worked the numbers for us on how danceable each track on the charts will be. According to these numebrs, the higher the danceabilty, the better time we'll have breaking it down. 

Firstly, we'll look at how the danceability of tracks has changed throughout the years. In our regression graph below, little to our surprise, you can see that the disco era has proven in the numbers to have produced the music that speaks to our body and soul. Yes, boogie will always be king! 
...
As a interesting topic, we decided to run sentiment analysis on the lyrics provided by each song and artist, to determine if artists over the years tend to write about more negative or positive sentiments.
